...
public class FsMappingTest extends AbstractFSCrawlerMetadataTestCase {/*
	...
	public void fsSettingsForDocSpecificJobVersion2() throws Exception {
		String settings = readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "2",
				INDEX_SETTINGS_FILE);
	...
	public void fsSettingsForDocSpecificJobVersion5() throws Exception {
		String settings = readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "5",
				INDEX_SETTINGS_FILE);
	...
	public void fsSettingsForDocSpecificJobVersion6() throws Exception {
		String settings = readJsonFile(metadataDir.resolve("jobtest").resolve("_mappings"), metadataDir, "6",
				INDEX_SETTINGS_FILE);
